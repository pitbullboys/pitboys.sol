...
contract PitbullBoys is Context, IERC20, Ownable {
    ...
    string private _name = "Pitbull Boys";
    string private _symbol = "PITBOYS";
    ...
    address public charityWallet = 0xE524541A7Fd3838aDe085706EAD1acF6148CB63E;
    ...
    uint256 public numTokensSellToAddToLiquidity = 10000000000000000 * 10**9;
    ...
    function setFees(uint256 taxFee, uint256 liquidityFee, uint256 charityFee, uint256 burnFee) external onlyOwner() {
        _taxFee = taxFee;
